...
/// query text field can be customized via [CustomSearchDelegate.buildLeading] and
/// [CustomSearchDelegate.buildActions].
///
...
abstract class CustomSearchDelegate<T> {
  ...
  /// {@tool snippet}
  /// ```dart
  /// class CustomSearchHintDelegate extends CustomSearchDelegate {
